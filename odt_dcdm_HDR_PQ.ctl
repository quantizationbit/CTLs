...
const float norm = (0.3143/0.3429)/10000.0;
...
// basically when oces is divided by SCALE_MAX (ocesScale) any value below 0.0001 will be clipped
  ...
  // Output in X'Y'Z' PQ
    ...
    outputCV = clamp_f3(XYZ,0.,1.0); 
    

  outputCV[0] = PQ10000_r(MAX*norm*outputCV[0]);
  outputCV[1] = PQ10000_r(MAX*norm*outputCV[1]);
  outputCV[2] = PQ10000_r(MAX*norm*outputCV[2]); 
